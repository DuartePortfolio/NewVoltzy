...
const ChooseARoomScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const loadRooms = async () => {
    ...
    try {
      setLoading(true);
      const roomsData = await housesService.getRooms(currentHouse.id);
      const roomNames = roomsData.map((room) => room.name).filter(Boolean);
      setRooms(roomNames);
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.backgroundSvg} pointerEvents="none">
        ...
        <Defs>
          <LinearGradient id="bgGradient" x1="0" y1="0" x2="0" y2="1">
            ...
            <Stop offset="0.9087" stopColor={theme.gradient[1]} />
          </LinearGradient>
          ...
          <LinearGradient id="blob6" x1="429.637" y1="415" x2="429.637" y2="671.273">
            <Stop offset="0.0913" stopColor={theme.gradient[1]} />
            <Stop offset="1" stopColor={theme.gradient[0]} />
          </LinearGradient>
        </Defs>
      ...
      <View style={styles.bottomNav}>
        <View style={[styles.navBackground, { backgroundColor: theme.colors.tabBar }]} />
        
        {/* Active indicator circle */}
        <Svg height={77} width={80} style={styles.activeIndicator}>
          <Ellipse cx={40} cy={38.5} rx={40} ry={38.5} fill={theme.colors.tabIconActiveBg} />
        </Svg>
          ...
          <TouchableOpacity style={styles.navItem} activeOpacity={0.7}>
            <Svg width={40} height={40} viewBox="0 0 40 40" fill="none">
              <Path
                ...
                fill={theme.colors.tabIconActive}
              />
              <Path
          ...
          <TouchableOpacity style={styles.navItem} activeOpacity={0.7}>
            <Svg width={40} height={40} viewBox="0 0 40 40" fill="none">
              <Path
                ...
                strokeLinejoin="round"
              />
              <Path d="M13.3333 3.3335V6.66683M25 3.3335V6.66683M3.33325 13.3335H34.9999" stroke={theme.colors.tabIcon} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
              <Path
